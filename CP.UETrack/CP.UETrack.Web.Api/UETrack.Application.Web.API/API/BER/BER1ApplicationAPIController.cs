...
namespace UETrack.Application.Web.API.API.BER
{
    ...
    {
        private readonly IBER1ApplicationBAL _bal;
        private readonly ICommonBAL _common;
        private readonly string fileName = nameof(BER1ApplicationAPIController);
        readonly UserDetailsModel _UserSession = new SessionHelper().UserSession();
        public BER1ApplicationAPIController(IBER1ApplicationBAL bal, ICommonBAL common)
        {
            _bal = bal;
            _common = common;
        }
        ...
        [HttpPost]
        [Route("add")]
        public HttpResponseMessage Post(BERApplicationTxn model)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        var ResultData = _bal.Get(modelTxn.ApplicationId);
                    ...
                    {
                        var ResultData = _bal.ArpGet(modelTxn.ApplicationId);
                        // ResultData.WorkingCalendar = modelTxn;
                        responseObject = (modelTxn != null) ? responseObject = BuildResponseObject(HttpStatusCode.Created, JsonConvert.SerializeObject(ResultData)) : responseObject = BuildResponseObject(false, resxFileHelper.GetErrorMessagesFromResource("CreateFailed"));
        ...
        public HttpResponseMessage GetAll()
        {
            try
            {
                ...
                var modelName = nameof(BERApplicationTxn);
        ...
        //    {
        //        Log4NetLogger.LogEntry(fileName, nameof(Get), Level.Info.ToString());
        //        var result = _bal.Get(CustomerId, ScreenId);
        //        if (result == null)
        //        {
        //            responseObject = BuildResponseObject(HttpStatusCode.NotFound);
        //        }
