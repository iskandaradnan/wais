...
namespace UETrack.Application.Web.API.API.CLS
{
    ...
    public class FETCApiController : BaseApiController
    {
        ...
        public FETCApiController(IFETCBAL fetcBAL, ICommonBAL common)
        {
            _fetcBAL = fetcBAL;
            _commonBAL = common;
        }
        ...
        [HttpPost]
        [Route(nameof(Save))]
        public HttpResponseMessage Save(FETC model)
        {
            try
            {
        ...
        public HttpResponseMessage GetAll()
        {
            ...
            try
            {
                ...
                paginationFilter = GridHelper.GetAllFormatSearchCondition<FETC>(Request.GetQueryNameValuePairs());
