...
namespace UETrack.Application.Web.API.API.CLS
{
    ...
    public class CLSCorrectiveActionReportApiController : BaseApiController
    {
        ...
        public CLSCorrectiveActionReportApiController(ICorrectiveActionReportBAL correctiveActionReportBAL)
        {
        ...
        public HttpResponseMessage AutoGeneratedCode()
        {
            ...
            try
            {
                ...
                var result = _CorrectiveActionReportBAL.AutoGeneratedCode();
                var serialisedData = JsonConvert.SerializeObject(result);
                responseObject = serialisedData == null ? BuildResponseObject(HttpStatusCode.NotFound) : BuildResponseObject(HttpStatusCode.OK, serialisedData);
        ...
        [HttpPost]
        [Route(nameof(CARNoFetch))]
        public HttpResponseMessage CARNoFetch(CorrectiveActionReport SearchObject)
        {
            try
            {
                Log4NetLogger.LogEntry(_FileName, nameof(CARNoFetch), Level.Info.ToString());
                var ErrorMessage = string.Empty;
                var result = _CorrectiveActionReportBAL.CARNoFetch(SearchObject);
                if (result == null)
                {
        ...
        [HttpPost]
        [Route(nameof(Save))]
        public HttpResponseMessage Save(CorrectiveActionReport model)
        {
            try
            {
                var ErrorMessage = string.Empty;
                var result = _CorrectiveActionReportBAL.Save(model, out ErrorMessage);
        ...
        public HttpResponseMessage AttachmentSave(CorrectiveActionReport model)
        {
            try
            {
                var ErrorMessage = string.Empty;
                var result = _CorrectiveActionReportBAL.AttachmentSave(model, out ErrorMessage);
        ...
        public HttpResponseMessage GetAll()
        {
            ...
            try
            {
                Log4NetLogger.LogEntry(_FileName, nameof(GetAll), Level.Info.ToString());
                 ...
                 CP.UETrack.Model.SortPaginateFilter paginationFilter = null;
        ...
        public HttpResponseMessage Get(int Id)
        {
            try
            {
                ...
                var result = _CorrectiveActionReportBAL.Get(Id);
                var serialisedData = JsonConvert.SerializeObject(result);
                responseObject = serialisedData == null ? BuildResponseObject(HttpStatusCode.NotFound) : BuildResponseObject(HttpStatusCode.OK, serialisedData);
