...
namespace UETrack.Application.Web.API.API.CLS
{
    ...
    {
        IDailyCleaningActivityBAL _dailyCleaningActivityBAL;
        private readonly string _FileName = nameof(DailyCleaningActivityApiController);
        private readonly ICommonBAL _commonBAL;

        public DailyCleaningActivityApiController(IDailyCleaningActivityBAL dailyCleaningActivityBAL, ICommonBAL common)
        {
            _dailyCleaningActivityBAL = dailyCleaningActivityBAL;
            _commonBAL = common;
        }
        [HttpGet]
        [Route(nameof(Load))]
        public HttpResponseMessage Load()
        {
            try
            {
                ...
                var result = _dailyCleaningActivityBAL.Load();
                if (result == null)
                {
        ...
        public HttpResponseMessage AutoGeneratedCode()
        {
            ...
            try
            {
                ...
                var result = _dailyCleaningActivityBAL.AutoGeneratedCode();
                var serialisedData = JsonConvert.SerializeObject(result);
        ...
        public HttpResponseMessage DocFetch(DailyCleaningActivity daily)
        {
            ...
            try
            {
                ...
                var result = _dailyCleaningActivityBAL.DocFetch(daily);
        ...
        [HttpPost]
        [Route(nameof(Save))]
        public HttpResponseMessage Save(DailyCleaningActivity model)
        {
            try
            {
                var ErrorMessage = string.Empty;
                var result = _dailyCleaningActivityBAL.Save(model, out ErrorMessage);
        ...
        public HttpResponseMessage GetAll()
        {
            ...
            try
            {
                ...
                paginationFilter = GridHelper.GetAllFormatSearchCondition<DailyCleaningActivity>(Request.GetQueryNameValuePairs());
                var commonDAL = new CommonDAL();
                paginationFilter = commonDAL.GetProperPaginationFilter(paginationFilter);

                var modelName = nameof(DailyCleaningActivity);
                var result = _dailyCleaningActivityBAL.GetAll(paginationFilter);
        ...
        public HttpResponseMessage Get(int Id)
        {
            ...
            try
            {
                ...
                var result = _dailyCleaningActivityBAL.Get(Id);
                var serialisedData = JsonConvert.SerializeObject(result);
                responseObject = serialisedData == null ? BuildResponseObject(HttpStatusCode.NotFound) : BuildResponseObject(HttpStatusCode.OK, serialisedData);
