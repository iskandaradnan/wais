...
namespace UETrack.Application.Web.API.API.BEMS
{
    ...
    public class ContractOutRegisterApiController : BaseApiController
    {
        ...
        private readonly IContractOutRegisterBAL _IContractOutRegisterBAL;
        private readonly string fileName = nameof(ContractOutRegisterApiController);

        public ContractOutRegisterApiController(IContractOutRegisterBAL IContractOutRegisterBAL)
        {

            _IContractOutRegisterBAL = IContractOutRegisterBAL;
        }
