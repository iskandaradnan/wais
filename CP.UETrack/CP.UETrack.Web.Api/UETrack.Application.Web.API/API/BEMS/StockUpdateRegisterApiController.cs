...
namespace UETrack.Application.Web.API.API.BEMS
{
    ...
    public class StockUpdateRegisterApiController : BaseApiController
    {
        ...
        private readonly IStockUpdateRegisterBAL _StockUpdateRegisterBAL;
        private readonly string fileName = nameof(StockUpdateRegisterApiController);
      
        public StockUpdateRegisterApiController(IStockUpdateRegisterBAL StockUpdateRegisterBAL)
        {

            _StockUpdateRegisterBAL = StockUpdateRegisterBAL;
        }
        [HttpPost]
        [Route("save")]
