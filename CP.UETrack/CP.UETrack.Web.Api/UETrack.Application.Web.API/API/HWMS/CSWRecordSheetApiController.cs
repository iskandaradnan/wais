...
namespace UETrack.Application.Web.API.API.HWMS
{
    ...
    {
        ICSWRecordSheetBAL _cswrecordsheetBAL;
        private readonly string _FileName = nameof(CSWRecordSheetApiController);
        private readonly ICommonBAL _commonBAL;

        public CSWRecordSheetApiController(ICSWRecordSheetBAL cswrecordBAL, ICommonBAL common)
        {
            _cswrecordsheetBAL = cswrecordBAL;
            _commonBAL = common;
        }
        [HttpGet]
        [Route(nameof(Load))]
        public HttpResponseMessage Load()
        {
            try
            {
                ...
                var result = _cswrecordsheetBAL.Load();
        ...
        public HttpResponseMessage AutoGeneratedCode()
        {
            ...
            try
            {
                ...
                var result = _cswrecordsheetBAL.AutoGeneratedCode();
                var serialisedData = JsonConvert.SerializeObject(result);
                responseObject = serialisedData == null ? BuildResponseObject(HttpStatusCode.NotFound) : BuildResponseObject(HttpStatusCode.OK, serialisedData);
        ...
        [HttpPost]
        [Route(nameof(Save))]
        public HttpResponseMessage Save(CSWRecordSheet model)
        {
            try
            {
                var ErrorMessage = string.Empty;
                var result = _cswrecordsheetBAL.Save(model, out ErrorMessage);
        ...
        public HttpResponseMessage GetAll()
        {
            ...
            try
            {
                ...
                paginationFilter = GridHelper.GetAllFormatSearchCondition<CSWRecordSheet>(Request.GetQueryNameValuePairs());
                var commonDAL = new CommonDAL();
                paginationFilter = commonDAL.GetProperPaginationFilter(paginationFilter);


                var result = _cswrecordsheetBAL.GetAll(paginationFilter);
        ...
        public HttpResponseMessage Get(int Id)
        {
            try
            {
                ...
                var result = _cswrecordsheetBAL.Get(Id);
                var serialisedData = JsonConvert.SerializeObject(result);
                responseObject = serialisedData == null ? BuildResponseObject(HttpStatusCode.NotFound) : BuildResponseObject(HttpStatusCode.OK, serialisedData);
        ...
        public HttpResponseMessage AutoDisplaying()
        {
            ...
            try
            {
                ...
                var result = _cswrecordsheetBAL.AutoDisplaying();
                var serialisedData = JsonConvert.SerializeObject(result);
                responseObject = serialisedData == null ? BuildResponseObject(HttpStatusCode.NotFound) : BuildResponseObject(HttpStatusCode.OK, serialisedData);
        ...
        public HttpResponseMessage WasteCodeGet(string WasteType)
        {
            try
            {
                ...
                var result = _cswrecordsheetBAL.WasteCodeGet(WasteType);
                var serialisedData = JsonConvert.SerializeObject(result);
                responseObject = serialisedData == null ? BuildResponseObject(HttpStatusCode.NotFound) : BuildResponseObject(HttpStatusCode.OK, serialisedData);
