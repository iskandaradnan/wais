...
namespace UETrack.Application.Web.API.API.HWMS
{
    ...
    public class HWMSQualityCauseMasterApiController : BaseApiController
    {
        ...
        public HWMSQualityCauseMasterApiController(IQualityCauseMasterBAL qualityCauseMasterBAL, ICommonBAL common)
        {
            _qualityCauseMasterBAL = qualityCauseMasterBAL;
            _commonBAL = common;
        }
        ...
        [HttpPost]
        [Route(nameof(Save))]
        public HttpResponseMessage Save(QualityCauseMaster model)
        {
            try
            {
                var ErrorMessage = string.Empty;
                var result = _qualityCauseMasterBAL.Save(model, out ErrorMessage);
        ...
        public HttpResponseMessage GetAll()
        {
            ...
            try
            {
                ...
                paginationFilter = GridHelper.GetAllFormatSearchCondition<QualityCauseMaster>(Request.GetQueryNameValuePairs());
                var commonDAL = new CommonDAL();
                paginationFilter = commonDAL.GetProperPaginationFilter(paginationFilter);

                var modelName = nameof(QualityCauseMaster);
        ...
        public HttpResponseMessage Get(int Id)
        {
            ...
            try
            {
                ...
                var result = _qualityCauseMasterBAL.Get(Id);
                var serialisedData = JsonConvert.SerializeObject(result);
                responseObject = serialisedData == null ? BuildResponseObject(HttpStatusCode.NotFound) : BuildResponseObject(HttpStatusCode.OK, serialisedData);
