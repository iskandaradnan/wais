...
namespace UETrack.Application.Web.API.API.MASTER
{
    ...
    {
        IUserTrainingBAL _UserTrainingBAL;
        private readonly ICommonBAL _commonBAL;
        private readonly string _FileName = nameof(MasterUserTrainingAPIController);
        public MasterUserTrainingAPIController(IUserTrainingBAL accountBAL, ICommonBAL common)
        {
            _UserTrainingBAL = accountBAL;
            _commonBAL = common;
        }
        ...
        public HttpResponseMessage Load()
        {
            ...
            try
            {
                ...
                var result = _UserTrainingBAL.Load();
        ...
        [HttpPost]
        [Route(nameof(Save))]
        public HttpResponseMessage Save(UserTrainingCompletion usertrain)
        {
            ...
            try
            {
                ...
                var result = _UserTrainingBAL.Save(usertrain, out ErrorMessage);
                ...
                {
                    result = _UserTrainingBAL.Get(result.TrainingScheduleId, 5, 1);
        ...
        public HttpResponseMessage GetAll()
        {
            ...
            try
            {
                ...
                paginationFilter = GridHelper.GetAllFormatSearchCondition<UserTrainingCompletion>(Request.GetQueryNameValuePairs());
                var commonDAL = new CommonDAL();
                paginationFilter = commonDAL.GetProperPaginationFilter(paginationFilter);

                var modelName = nameof(UserTrainingCompletion);
                var result = _UserTrainingBAL.GetAll(paginationFilter);
        ...
        public HttpResponseMessage Get(int Id, int pagesize, int pageindex)
        {
            ...
            try
            {
                ...
                var result = _UserTrainingBAL.Get(Id, pagesize, pageindex);
                var serialisedData = JsonConvert.SerializeObject(result);
                responseObject = serialisedData == null ? BuildResponseObject(HttpStatusCode.NotFound) : BuildResponseObject(HttpStatusCode.OK, serialisedData);
        ...
        [HttpPost]
        [Route(nameof(SaveFeedback))]
        public HttpResponseMessage SaveFeedback(TrainingFeedback feedback)
        {
            ...
            try
            {
                ...
                var ErrorMessage = string.Empty;
                var result = _UserTrainingBAL.SaveFeedback(feedback, out ErrorMessage);
                ...
                {
                    //result = _UserTrainingBAL.GetFeedback(result.TrainingFeedbackId);
                    responseObject = BuildResponseObject(HttpStatusCode.OK, JsonConvert.SerializeObject(result));
        ...
        public HttpResponseMessage GetFeedback(int Id)
        {
            ...
            try
            {
                ...
                var result = _UserTrainingBAL.GetFeedback(Id);
                var serialisedData = JsonConvert.SerializeObject(result);
                responseObject = serialisedData == null ? BuildResponseObject(HttpStatusCode.NotFound) : BuildResponseObject(HttpStatusCode.OK, serialisedData);
