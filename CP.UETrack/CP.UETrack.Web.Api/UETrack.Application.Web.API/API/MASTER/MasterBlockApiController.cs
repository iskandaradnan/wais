...
namespace UETrack.Application.Web.Controllers
{
    ...
    {
        IMasterBlockBAL _BlockBAL;
        //IMasterBlockBAL _MasterBlockBAL;
        ...
        {
            _BlockBAL = new MasterBlockBAL();
        }

        public MasterBlockApiController(IMasterBlockBAL accountBAL, ICommonBAL common)
        {
            _BlockBAL = accountBAL;
            //_MasterBlockBAL = accountBAL;
            _commonBAL = common;
        }
