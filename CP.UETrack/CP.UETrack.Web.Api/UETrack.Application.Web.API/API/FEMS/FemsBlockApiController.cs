...
namespace UETrack.Application.Web.Controllers
{
    ...
    {
        IFemsBlockBAL _BlockBAL;
        private readonly string _FileName = nameof(FemsBlockApiController);
        private readonly ICommonBAL _commonBAL;
        public FemsBlockApiController(IFemsBlockBAL accountBAL, ICommonBAL common)
        {
        ...
        public HttpResponseMessage GetAll()
        {
            ...
            try
            {
                ...
                var result = _commonBAL.FEMSGetAll(paginationFilter, modelName);
