...
namespace UETrack.Application.Web.API.API.VM
{
    ...
    public class SNFAPIController : BaseApiController
    {
        ...
        public SNFAPIController(ISNFBAL ISNFBAL)
        {
            _ISNFBAL = ISNFBAL;
        }
        ...
        [HttpPost]
        [Route(nameof(Save))]
        public HttpResponseMessage Save(SNFEntity testingAndCommissioning)
        {
            ...
            try
            {
                ...
                var result = _ISNFBAL.Save(testingAndCommissioning, out ErrorMessage);
        ...
        public HttpResponseMessage GetAll()
        {
            ...
            try
            {
                ...
                paginationFilter = GridHelper.GetAllFormatSearchCondition<SNFGetallEntity>(Request.GetQueryNameValuePairs());
                var commonDAL = new CommonDAL();
                paginationFilter = commonDAL.GetProperPaginationFilter(paginationFilter);

                var result = _ISNFBAL.GetAll(paginationFilter);
                if (result == null)
                {
                    responseObject = BuildResponseObject(HttpStatusCode.NotFound);
                }
        ...
        public HttpResponseMessage Delete(int Id)
        {
            ...
            try
            {
                ...
                var ErrorMessage = string.Empty;
                _ISNFBAL.Delete(Id, out ErrorMessage);
