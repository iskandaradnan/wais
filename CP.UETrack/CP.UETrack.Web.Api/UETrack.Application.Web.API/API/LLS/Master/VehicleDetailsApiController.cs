...
namespace UETrack.Application.Web.API.API.LLS.Master
{
    ...
    {
        private readonly IVehicleDetailsBAL _bal;
        private readonly string fileName = nameof(VehicleDetailsApiController);


        public VehicleDetailsApiController(IVehicleDetailsBAL bal)
        {
            _bal = bal;
        }
        ...
        [HttpPost]
        [Route(nameof(Save))]
        public HttpResponseMessage Save(VehicleDetailsModel model)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        var ResultData = _bal.Get(result.VehicleId);
        ...
        public HttpResponseMessage GetAll()
        {
            ...
            try
            {
                ...
                paginationFilter = GridHelper.GetAllFormatSearchCondition<VehicleDetailsModelFilter>(Request.GetQueryNameValuePairs());
