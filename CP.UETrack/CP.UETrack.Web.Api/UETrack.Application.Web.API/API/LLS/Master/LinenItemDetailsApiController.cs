...
namespace UETrack.Application.Web.API.API.LLS.Master
{
    ...
    {
        private readonly ILinenItemDetailsBAL _bal;
        private readonly string fileName = nameof(LinenItemDetailsApiController);


        public LinenItemDetailsApiController(ILinenItemDetailsBAL bal)
        {
            _bal = bal;
        }
        ...
        [HttpPost]
        [Route(nameof(Save))]
        public HttpResponseMessage Save(LinenItemDetailsModel model)
        {
            try
            {
        ...
        public HttpResponseMessage GetAll()
        {
            ...
            try
            {
                ...
                paginationFilter = GridHelper.GetAllFormatSearchCondition<LinenItemDetailsModel>(Request.GetQueryNameValuePairs());
