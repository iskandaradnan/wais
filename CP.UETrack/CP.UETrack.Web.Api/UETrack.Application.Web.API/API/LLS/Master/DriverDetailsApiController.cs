...
namespace UETrack.Application.Web.API.API.LLS
{
    ...
    {
        private readonly IDriverDetailsBAL _bal;
        private readonly string fileName = nameof(DriverDetailsApiController);


        public DriverDetailsApiController(IDriverDetailsBAL bal)
        {
            _bal = bal;
        }
        ...
        [HttpPost]
        [Route(nameof(Save))]
        public HttpResponseMessage Save(DriverDetailsModel model)
        {
            try
            {
        ...
        public HttpResponseMessage GetAll()
        {
            ...
            try
            {
                ...
                paginationFilter = GridHelper.GetAllFormatSearchCondition<DriverDetailsModelFilter>(Request.GetQueryNameValuePairs());
