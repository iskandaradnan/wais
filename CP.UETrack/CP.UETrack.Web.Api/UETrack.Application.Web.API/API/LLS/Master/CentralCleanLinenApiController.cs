...
namespace UETrack.Application.Web.API.API.LLS
{
    ...
    {
        private readonly ICentralCleanLinenStoreBAL  _bal;
        private readonly string fileName = nameof(CentralCleanLinenApiController);


        public CentralCleanLinenApiController(ICentralCleanLinenStoreBAL bal)
        {
            _bal = bal;
        }
        ...
        [HttpPost]
        [Route(nameof(Save))]
        public HttpResponseMessage Save(CentralCleanLinenStoreModel model)
        {
            try
            {
        ...
        public HttpResponseMessage GetAll()
        {
            ...
            try
            {
                ...
                paginationFilter = GridHelper.GetAllFormatSearchCondition<CentralCleanLinenStoreModel>(Request.GetQueryNameValuePairs());
