...
namespace UETrack.Application.Web.API.API.LLS.Master
{
    ...
    public class LaundryPlantAPIController : BaseApiController
    {
        ...
        // GET: LandryPlantAPI
        private readonly ILaundryPlantBAL _bal;
        private readonly string fileName = nameof(LaundryPlantAPIController);


        public LaundryPlantAPIController(ILaundryPlantBAL bal)
        {
            _bal = bal;
        }
        ...
        [HttpPost]
        [Route(nameof(Save))]
        public HttpResponseMessage Save(LaundryPlantModel model)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (result == null || result.LaundryPlantId == 0)
                        BuildResponseObject(false, resxFileHelper.GetErrorMessagesFromResource("CreateFailed"));
                    else
                    {
                        var ResultData = _bal.Get(result.LaundryPlantId);
        ...
        public HttpResponseMessage GetAll()
        {
            ...
            try
            {
                ...
                paginationFilter = GridHelper.GetAllFormatSearchCondition<LaundryPlantModelFilter>(Request.GetQueryNameValuePairs());
