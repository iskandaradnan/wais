...
namespace UETrack.Application.Web.API.API.LLS.Transaction
{
    ...
    {
        private readonly ILinenRepairBAL _bal;
        private readonly string fileName = nameof(LinenRepairApiController);


        public LinenRepairApiController(ILinenRepairBAL bal)
        {
            _bal = bal;
        }
        ...
        [HttpPost]
        [Route(nameof(Save))]
        public HttpResponseMessage Save(LinenRepairModel model)
        {
            try
            {
        ...
        public HttpResponseMessage GetAll()
        {
            ...
            try
            {
                ...
                paginationFilter = GridHelper.GetAllFormatSearchCondition<LinenRepairModel>(Request.GetQueryNameValuePairs());
