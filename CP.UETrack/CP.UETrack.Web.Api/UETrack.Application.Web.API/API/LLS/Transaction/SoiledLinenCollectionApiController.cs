...
namespace UETrack.Application.Web.API.API.LLS.Transaction
{
    ...
    {
        private readonly ISoiledLinenCollectionBAL _bal;
        private readonly string fileName = nameof(SoiledLinenCollectionApiController);


        public SoiledLinenCollectionApiController(ISoiledLinenCollectionBAL bal)
        {
            _bal = bal;
        }
        ...
        [HttpPost]
        [Route(nameof(Save))]
        public HttpResponseMessage Save(soildLinencollectionsModel model)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (result == null || result.SoiledLinenCollectionId == 0)
                        BuildResponseObject(false, resxFileHelper.GetErrorMessagesFromResource("CreateFailed"));
                    else
                    {
                        var ResultData = _bal.Get(result.SoiledLinenCollectionId);
        ...
        //[HttpPost]
        //[Route(nameof(GetBySchedule))]
        //public HttpResponseMessage GetBySchedule(soildLinencollectionsModel model)
        //{
        //    try
        //    {
        //        var ErrorMessage = string.Empty;
        //        var result = _bal.GetBySchedule(model, out ErrorMessage);
        ...
        //        }
        //        Log4NetLogger.LogExit(fileName, nameof(GetBySchedule), Level.Info.ToString());
        //    }
        //    catch (Exception ex)
        //    {
        //        returnMessage = $"{resxFileHelper.GetErrorMessagesFromResource("GeneralException")} : {ex.Message}";
        ...
        public HttpResponseMessage GetAll()
        {
            ...
            try
            {
                ...
                paginationFilter = GridHelper.GetAllFormatSearchCondition<soildLinencollectionsModel_Filter>(Request.GetQueryNameValuePairs());
