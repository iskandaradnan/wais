...
{
    public interface IFetchDAL
    {
        List<UMStaffSearch> FetchStaffMaster(UMStaffSearch SearchObject);
        ...
        List<ParentAssetNoSearch> AssetNoFetch(ParentAssetNoSearch SearchObject);
