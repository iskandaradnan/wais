...
{
    public interface IAssetQRCodePrintDAL
    {
        ...
        bool IsRecordModified(AssetQRCodePrintModel AssetQR);
        bool IsAssetQRCodePrintCodeDuplicate(AssetQRCodePrintModel AssetQR);
    }
}
