...
namespace CP.UETrack.DAL.DataAccess
{
    ...
    public class FEMSBlockDAL : IFEMSBlockDAL
    {
        private readonly string _FileName = nameof(FEMSBlockDAL);
        ...
        public bool IsBlockCodeDuplicate(BlockMstViewModel Block)
        {
            try
            {
                ...
                string constring = ConfigurationManager.ConnectionStrings["FEMSUETrackConnectionString"].ConnectionString;
