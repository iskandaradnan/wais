    ...
    $("#btnCSWRSDetailsFetch").click(function () {        var StartDate = $('#txtStartDate').val();        var EndDate = $('#txtEndDate').val();        if (StartDate != 0 & EndDate != 0) {            var obj = {                StartDate: StartDate,                EndDate: EndDate            }
                    ...
                    if (result.CSWRSDetailsFetchList != null) {
                            ...
                            for (var i = 0; i < result.CSWRSDetailsFetchList.length; i++) {
                                ...
                                var CSWRSNo = '<td>  <input type="text" required class="form-control" id="txtCSWRSNo' + rowNum2 + '"  autocomplete="off" name="CSWRSNo" maxlength="25" tabindex="2" /></td>';
...
function addAddCSWRSRecords(num) {
    ...
    var CSWRSNo = '<td>  <input type="text" required class="form-control" id="txtCSWRSNo' + num + '"  autocomplete="off" name="CSWRSNo" maxlength="25" tabindex="2" /></td>';
