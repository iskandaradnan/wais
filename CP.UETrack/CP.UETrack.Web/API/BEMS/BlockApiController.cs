...
namespace UETrack.Application.Web.Controllers
{
    ...
    public class BlockApiController : BaseApiController
    {
        ...
        public async Task<HttpResponseMessage> Load()
        {
            ...
            var result = await RestHelper.ApiGet("Block/Load");
            Log4NetLogger.LogEntry(_FileName, nameof(Load), Level.Info.ToString());
            return result;
        }
        ...
        public async Task<HttpResponseMessage> Save(HttpRequestMessage request, [FromBody] BlockMstViewModel Block)
        {
            ...
            var result = await RestHelper.ApiPost("Block/Save", Block);
            Log4NetLogger.LogEntry(_FileName, nameof(Save), Level.Info.ToString());
            return result;
        }
        ...
        public async Task<HttpResponseMessage> GetAll()
        {
            ...
            var result = await RestHelper.ApiGet(string.Format("Block/GetAll?{0}", filterData));
            Log4NetLogger.LogEntry(_FileName, nameof(GetAll), Level.Info.ToString());
            return result;
        }
        ...
        public async Task<HttpResponseMessage> Get(int Id)
        {
            ...
            var result = await RestHelper.ApiGet(string.Format("Block/Get/{0}", Id));
            Log4NetLogger.LogEntry(_FileName, nameof(Get), Level.Info.ToString());
            return result;
        }
        [HttpGet("Delete/{Id}")]
        public async Task<HttpResponseMessage> Delete(int Id)
        {
            ...
            var result = await RestHelper.ApiGet(string.Format("Block/Delete/{0}", Id));
            Log4NetLogger.LogEntry(_FileName, nameof(Delete), Level.Info.ToString());
            return result;
        }
    }
