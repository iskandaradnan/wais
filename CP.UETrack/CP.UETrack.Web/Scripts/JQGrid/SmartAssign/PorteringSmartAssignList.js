$(function () {
    var StatusValues = "Check In:Check In;Check Out:Check Out;Check In Workshop:Check In Workshop;Check Out Workshop:Check Out Workshop;";
    var UserTypeValues = "Manual Assigned:Manual Assigned;Smart Assigned:Smart Assigned;";
...
function genarateGrid(statusValues, userTypeValues) {
    ...
    grid.jqGrid({       
        url: "/api/PorteringSmartAssign/PorteringSmartAssignGetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['Id', 'Customer Name', 'Facility Name', 'Asset Tracker No.', 'Asset Tracker Status', 'Assigned Type', 'Assigned Name'],
        colModel: [
            ...
            { key: false, search: true, name: 'PorteringNo', width: '15%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },          

            { key: false, name: 'PorteringStatusValue', width: '15%', stype: "select", searchoptions: { sopt: ["eq", "ne"], value: StatusValues, defaultValue: "Check In" } },

            { key: false, name: 'AssigneeType', width: '15%', stype: "select", searchoptions: { sopt: ["eq", "ne"], value: UserTypeValues, defaultValue: "Manual Assigned" } },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("Smart_Assign_Asset_Tracker"))
          .append($("<input name='spName' type='text'>").val("uspFM_GetAssignedPortering_GetAll_Export"))
