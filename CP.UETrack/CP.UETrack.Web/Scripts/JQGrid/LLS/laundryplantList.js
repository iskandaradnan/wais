$(function () {
    ...
    var OwnershipValue = "Owned : Owned; Outsourced: Outsourced; OnSiteLaundry: OnSiteLaundry;";
    genarateGrid(StatusValues, OwnershipValue);
});

function genarateGrid(statusValues, ownershipValue) {
    ...
    var OwnershipValues = ownershipValue.replace(/[,;]$/, '').toString();
    var grid = $("#grid"),
        prmSearch = { multipleSearch: true, overlay: false };
    grid.jqGrid({
        url: "/api/LaundryPlant/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['Id', 'Laundry Plant Code', 'Laundry Plant Name', 'Ownership', 'Capacity(Tonne/Day)', 'Contact Person ', 'Status'],
        colModel: [
            { key: true, hidden: true, name: 'LaundryPlantId', width: '0%' },
            { key: true, search: true, name: 'LaundryPlantCode', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'LaundryPlantName', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'Ownership', width: '20%', stype: "select", searchoptions: { sopt: ["eq", "ne"], value: OwnershipValues, defaultValue: "Owned" } },
            { key: false, search: true, name: 'Capacity', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'ContactPerson', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("Laundryplant"))
        .append($("<input name='spName' type='text'>").val("LLSLaundryPlantMst_Export"))
