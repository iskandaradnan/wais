...
function genarateGrid() {
    ...
    grid.jqGrid({
        ...
        colNames: ['Id', ' Department Code', ' Department Name', 'Total No Of Assets','Schedule Type','Assignee', 'Status'],
        colModel: [
            ...
            { key: false, search: true, name: 'TotalNoOfAssets',align:'right', width: '12%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            //{ key: false, search: true, name: 'AssetDescription', width: '13%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            // { key: false, search: true, name: 'TaskCode', width: '13%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
              //{ key: false, search: true, name: 'ScheduleType', width: '9%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
               //{ key: false, search: true, name: 'Status', width: '7%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
                { key: false, search: true, name: 'ScheduleType', stype: "select", width: '9%', searchoptions: { sopt: ['eq', 'ne'], value: SearchBoxSelectFilterData.ScheduleType, defaultValue: "Monthly-Date" } },
                { key: false, search: true, name: 'Assignee', width: '7%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
              { key: false, search: true, name: 'StatusGrid', stype: "select", width: '7%', formatter: StatusCat, searchoptions: { sopt: ['eq', 'ne'], value: SearchBoxSelectFilterData.Status, defaultValue: "Active" } },
       ...
       // caption: 'RI PLanner',
        ...
        //        window.location.href = "/BEMS/RIPlanner/add";
        //    }
        //})
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("RI_Planner"))
        //.append($("<input name='screenName' type='text'>").val(screenTitle.split(" ").join('_')))
          .append($("<input name='spName' type='text'>").val("uspFM_EngPlannerTxn_RI_Export"))
