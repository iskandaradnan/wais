$(function () {
    ...
    var RequestService = "Advisory Services:Advisory Services;Alert:Alert;Feedback:Feedback;Hazard:Hazard;Incident:Incident;Recall:Recall;T&C:T&C;Obsolete:Obsolete;User Request:User Request;Non-Conformance:Non-Conformance;Statutory:Statutory;";
...
function genarateGrid(serviceValues, requestService) {
    ...
    //   // $("#grid").clear();
    //        if (serviceId == 1) {
    //            URLS = "/api/CRMRequestApi/Getall/1"

    //        }
    //        else
    //        {
    //            URLS = "/api/CRMRequestApi/Getall/2"
    //        }
    //    }
    ...
    grid.jqGrid({
        ...
        colNames: ['Id', 'Request No.', 'Request Date /Time', 'Request Type', 'Request Status', 'Model', 'Manufacturer', 'Requester', 'IsWorkOrder', 'Asset No'],
        colModel: [
       ...
       // caption: 'Customer Relationship Management',
        ...
        //        window.location.href = "/bems/crmrequest/add";
        //    }
        //})
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='sortColumnName' type='text'>").val(sortColumnName))
         .append($("<input name='screenName' type='text'>").val("Request"))
        .append($("<input name='screenName' type='text'>").val(screenTitle.split(" ").join('_')))
          .append($("<input name='spName' type='text'>").val("uspFM_CRMRequest_Export"))
