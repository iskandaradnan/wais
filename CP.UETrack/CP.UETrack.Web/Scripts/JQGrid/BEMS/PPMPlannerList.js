...
function genarateGrid() {
    ...
    var SearchBoxSelectFilterData = {
        ...
        TaskCodeOPtions: "Manual:Manual;Frequency:Frequency;".replace(/[,;]$/, '').toString()
    }
    ...
    grid.jqGrid({
        ...
        colNames: ['Id', 'Asset Classification Code', 'Asset Type Code', 'Asset Type Description', 'Asset No.', 'Task Code Option', 'Task Code', 'Schedule Type', 'Assignee', 'Status'],
        colModel: [
            { key: true, hidden: true, name: 'PlannerId', width: '0%' },
            { key: false, search: true, name: 'AssetClassificationDescription', width: '14%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'AssetTypeCode', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'AssetTypeDescription', width: '14%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'AssetNo', width: '12%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'TaskCodeOptionValue', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            //{ key: false, search: true, name: 'TaskCodeOptionValue', stype: "select", width: '10%', searchoptions: { sopt: ['eq', 'ne'], value: SearchBoxSelectFilterData.TaskCodeOPtions, defaultValue: "Manual" } },
            { key: false, search: true, name: 'TaskCode', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'ScheduleType', stype: "select", width: '10%', formatter: TypeCat, searchoptions: { sopt: ['eq', 'ne'], value: SearchBoxSelectFilterData.ScheduleType, defaultValue: "Monthly-Date" } },
            { key: false, search: true, name: 'Assignee', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'StatusGrid', stype: "select", width: '10%', formatter: StatusCat, searchoptions: { sopt: ['eq', 'ne'], value: SearchBoxSelectFilterData.Status, defaultValue: "Active" } },
        ],
        ...
        //        window.location.href = "/BEMS/PPMPlanner/add";
        //    }
        //})
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("PPM_Planner"))
      //  .append($("<input name='screenName' type='text'>").val(screenTitle.split(" ").join('_')))
          .append($("<input name='spName' type='text'>").val("uspFM_EngPlannerTxn_PPM_Export"))
