...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/EODParameterMapping/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['ParameterMappingId', 'Asset Classification', 'Asset Type Code', 'Asset Type Description', 'Model', 'Manufacturer'],
        colModel: [
            { key: true, hidden: true, name: 'ParameterMappingId', width: '0%' },
            { key: false, search: true, name: 'AssetClassification', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'AssetTypeCode', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
                        { key: false, search: true, name: 'AssetTypeDescription', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'Model', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'Manufacturer', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            //{ name: 'edit', search: false, index: 'ParameterMappingId', width: '5%', sortable: false, formatter: editLink },
            //{ name: 'delete', search: false, index: 'ParameterMappingId', width: '5%', sortable: false, formatter: deleteLink },
            //{ name: 'view', search: false, index: 'ParameterMappingId', width: '5%', sortable: false, formatter: viewLink }
        ],
        pager: jQuery('#pager'),
        rowNum: 5,
        rowList: [5, 10, 20, 50],
        ...
        width: '100%',
        viewrecords: true,
        //caption: 'Parameter Mapping BEMS',
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("Parameter_Mapping"))
        .append($("<input name='screenName' type='text'>").val(screenTitle.split(" ").join('_')))
          .append($("<input name='spName' type='text'>").val("uspFM_EngEODParameterMapping_Export"))
