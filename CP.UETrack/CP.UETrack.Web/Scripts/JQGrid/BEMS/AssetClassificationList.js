...
function genarateGrid(serviceValues) {
    ...
    grid.jqGrid({
        url: "/api/AssetClassification/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['Id', 'Asset Classification Code', 'Asset Classification Description', 'Remarks', 'Status'],
        colModel: [
            { key: true, hidden: true, name: 'AssetClassificationId', width: '0%' },
            { key: false, search: true, name: 'AssetClassificationCode', width: '30%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'AssetClassificationDescription', width: '30%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'Remarks', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'Active', width: '15%', stype: "select", searchoptions: { sopt: ["eq", "ne"], value: ServiceValues, defaultValue: "Active" } },
            //{ name: 'edit', search: false, index: 'AssetClassificationId', width: '5%', sortable: false, formatter: editLink },
            //{ name: 'delete', search: false, index: 'AssetClassificationId', width: '5%', sortable: false, formatter: deleteLink },
            //{ name: 'view', search: false, index: 'AssetClassificationId', width: '5%', sortable: false, formatter: viewLink },
        ...
        //        window.location.href = "/BEMS/AssetClassification/add";
        //    }
        //}
        //)
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("Asset_Classification"))
        ...
        .append($("<input name='spName' type='text'>").val("uspFM_EngAssetClassification_Export"))
...
function genarateGrid_FEMS(serviceValues) {
    var isFromSave = false;
    var gridClicked = false;
    var sv = 11;
    var ServiceValues = serviceValues.replace(/[,;]$/, '').toString();
    var grid = $("#grid"),
        prmSearch = { multipleSearch: true, overlay: false };
    grid.jqGrid({
        url: "/api/AssetClassification/GetAllFEMS",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['Id', 'Asset Classification Code', 'Asset Classification Description', 'Remarks', 'Status'],
