$(function () {
    var StatusValues = "Annually:Annually;Half Yearly:Half Yearly;Quarterly:Quarterly;Bi-Monthly:Bi-Monthly;Monthly:Monthly;Bi-Weekly:Bi-Weekly;Weekly:Weekly";
...
function genarateGrid(statusValues, userTypeValues) {
    ...
    grid.jqGrid({
        url: "/api/PPMChecklist/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['Id', 'Asset Type Code', 'Asset Type Description', 'Task Code', 'Model', 'Manufacturer', 'PPM Frequency', 'PPM Hours '],
        colModel: [
            { key: true, hidden: true, name: 'PPMCheckListId', width: '0%' },
            { key: false, search: true, name: 'AssetTypeCode', width: '15%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'AssetTypeDescription', width: '15%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'TaskCode', width: '15%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'Model', width: '15%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'Manufacturer', width: '15%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
             { key: false, search: true, name: 'PPMFrequencyValue', width: '15%', stype: "select", searchoptions: { sopt: ["eq", "ne"], value: StatusValues } },
             { key: false, search: true, name: 'PpmHours', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },

           // { key: false, name: 'StatusValue', width: '10%', stype: "select", searchoptions: { sopt: ["eq", "ne"], value: StatusValues, defaultValue: "Active" } },
            //{ name: 'edit', search: false, index: 'PPMCheckListId', width: '5%', sortable: false, formatter: editLink },
            //{ name: 'delete', search: false, index: 'PPMCheckListId', width: '5%', sortable: false, formatter: deleteLink },
            //{ name: 'view', search: false, index: 'PPMCheckListId', width: '5%', sortable: false, formatter: viewLink },
        ...
        //        window.location.href = "/BEMS/PPMChecklist/add";
        //    }
        //}
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
       ...
       .append($("<input name='screenName' type='text'>").val("PPM_Checklist"))
           .append($("<input name='headerColumnNames' type='text'>").val(headercolumns))
          .append($("<input name='spName' type='text'>").val("uspFM_EngAssetPPMCheckList_Export"))
