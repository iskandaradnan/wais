...
function genarateGrid(statusValues, ContractTypeValues, controllerName) {
    ...
    grid.jqGrid({
        ...
        colNames: ['ARPID', 'BERNO.', 'ConditionAppraisalNo', 'AssetNo', 'Asset Type Description', 'DepartmentName', 'LocationName'],
        colModel: [
            { key: true, hidden: true, name: 'ARPID', width: '0%' },
            { key: false, search: true, name: 'BERno', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'ConditionAppraisalNo', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            ...
            { key: false, search: true, name: 'UserAreaName', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'UserLocationName', width: '15%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
