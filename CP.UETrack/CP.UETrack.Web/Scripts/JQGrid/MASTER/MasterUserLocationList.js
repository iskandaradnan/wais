...
function genarateGrid(serviceValues) {
    ...
    grid.jqGrid({
        url: "/api/MasterUserLocation/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['Id', ' Location Code', ' Location Name', ' Department Code', ' Department Name', ' Block Name', 'Level Name', 'Status'],
        colModel: [

            { key: true, hidden: true, name: 'UserLocationId', width: '0%' },
            ...
            { key: false, search: true, name: 'UserAreaName', width: '30%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'BlockName', width: '15%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'LevelName', width: '15%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'StatusValue', width: '10%', stype: "select", searchoptions: { sopt: ["eq", "ne"], value: ServiceValues, defaultValue: "Active" } },
            //{ name: 'edit', search: false, index: 'UserLocationId', width: '5%', sortable: false, formatter: editLink },
            //{ name: 'delete', search: false, index: 'UserLocationId', width: '5%', sortable: false, formatter: deleteLink },
            //{ name: 'view', search: false, index: 'UserLocationId', width: '5%', sortable: false, formatter: viewLink },
       ...
       // caption: 'User Location Master',
        ...
        //        window.location.href = "/BEMS/UserLocation/add";
        //    }
        //}
        //)
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='sortColumnName' type='text'>").val(sortColumnName))
           .append($("<input name='screenName' type='text'>").val("Location"))
        .append($("<input name='headerColumnNames' type='text'>").val(headercolumns))
        .append($("<input name='spName' type='text'>").val("uspFM_MstLocationUserLocation_Export"))
