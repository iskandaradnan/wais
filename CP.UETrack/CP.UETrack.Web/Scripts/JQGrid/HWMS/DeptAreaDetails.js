...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/DeptAreaDetail/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['DeptAreaId', 'User Area Code', 'User Area Name','Operating Days','Status', 'Category'],
        colModel: [
            { key: true, hidden: true, name: 'DeptAreaId', width: '10%' },
            { key: false, name: 'UserAreaCode', search: true, width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'UserAreaName', search: true, width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, hidden: false, search: true, name: 'OperatingDays', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, hidden: false, search: true, name: 'Status', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, hidden: false, search: true, name: 'Category', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
         ],
        pager: jQuery('#pager'),
        rowNum: 5,
        rowList: [5, 10, 20, 50],
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='spName' type='text'>").val("sp_HWMS_DeptAreaDetails_Export"))
