...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/HWMSQualityCauseMaster/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['QCMId', 'Failure Symptom Code', 'Description'],
        colModel: [
            { key: true, search: false, hidden: true, name: 'QualityCauseMasterId', width: '0%' },
            { key: false, name: 'FailureSymptomCode', width: '50%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'Description', width: '50%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } }
        ],
        pager: jQuery('#pager'),
        rowNum: 5,
        rowList: [5, 10, 20, 50],
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("QualityCauseMaster"))
        .append($("<input name='spName' type='text'>").val("sp_HWMS_QualityCauseMaster_Export"))
