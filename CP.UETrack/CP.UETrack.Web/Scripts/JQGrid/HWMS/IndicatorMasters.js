...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/IndicatorMasterHWMS/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['Indicator MasterId', 'Indicator Number', 'Indicator Description'],
        colModel: [
            { key: true, search: false, hidden: true, name: 'IndicatorMasterId', width: '0%' },
            { key: false, search: true, name: 'IndicatorNo', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'IndicatorName', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("IndicatorMaster"))
        .append($("<input name='spName' type='text'>").val("Sp_HWMS_IndicatorMaster_Export"))
