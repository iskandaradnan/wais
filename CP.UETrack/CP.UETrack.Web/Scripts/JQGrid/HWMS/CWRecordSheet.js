...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/CWRecordSheet/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['CWRSId', 'Date', 'Total User Area', 'Total Bag Collected', 'Total Sanitized'],
        colModel: [
            { key: true, hidden: true, name: 'CWRecordSheetId', width: '0%' },
            { key: false, search: true, name: 'Date', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'TotalUserArea', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'TotalBagCollected', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'TotalSanitized', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("CWRecordSheet"))
        .append($("<input name='spName' type='text'>").val("Sp_HWMS_CWRecordSheet_Export"))
