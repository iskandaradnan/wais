...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/CorrectiveActionReports/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['CARId', 'CARNo', 'CARDate', 'Indicator', 'Status', 'Assignee', 'CARGeneration'],
        colModel: [
            { key: true, hidden: true, name: 'CARId', width: '0%' },
            { key: false, name: 'CARNo', width: '17%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'CARDate', width: '16%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'Indicator', width: '16%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'Status', width: '16%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'Assignee', width: '16%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'CARGeneration', width: '16%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } }
        ],
        pager: jQuery('#pager'),
        rowNum: 5,
        rowList: [5, 10, 20, 50],
        ...
        { cloneToTop: true, edit: false, add: false, del: false, search: false, refresh: true },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("CorrectiveActionReport"))
        .append($("<input name='spName' type='text'>").val("Sp_HWMS_CorrectiveActionReport_Export"))
