...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/DailyTemperatureLog/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['DailyId', 'Year', 'Month'],
        colModel: [
            { key: true, hidden: true, name: 'DailyId', width: '10%' },
            { key: false, name: 'Year', width: '50%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'Month', width: '50%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            //{ key: false, name: 'WasteCode', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            // { key: false, search: true, name: 'WasteDescription', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("DailyTemperatureLog"))
        .append($("<input name='spName' type='text'>").val("SP_HWMS_DailyTemperatureLog_Export"))
