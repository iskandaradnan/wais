...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/ConsumablesReceptacles/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['Consumables Id', 'Waste Category', 'Waste Type'],
        colModel: [
            { key: true, hidden: true, name: 'ConsumablesId', width: '11%' },
            { key: false, name: 'WasteCategory', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'WasteType', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("ConsumablesReceptacles"))
        .append($("<input name='spName' type='text'>").val("sp_HWMS_ConsumablesReceptacles_Export"))
