...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/HWMSDriverDetails/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        
        colNames: ['DriverId', 'Driver Code', 'Driver Name', 'Treatment Plant', 'Status', 'Effective From', 'Route'],
        colModel: [
            { key: true, hidden: true, name: 'DriverId', width: '0%' },
            { key: false, name: 'DriverCode', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'DriverName', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            ...
            { key: false, search: false, name: 'EffectiveFrom', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("DriverDetails"))
        .append($("<input name='spName' type='text'>").val("Sp_HWMS_DriverDetails_Export"))
