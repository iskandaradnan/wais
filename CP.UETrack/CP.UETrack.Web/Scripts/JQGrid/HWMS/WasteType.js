...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/WasteType/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['WasteTypeId', 'Waste Category', 'Waste Type'],
        colModel: [
            { key: true, hidden: true, name: 'WasteTypeId', width: '5%' },
            { key: false, name: 'WasteCategory', width: '50%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'WasteOfType', width: '50%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("WasteType"))
        .append($("<input name='spName' type='text'>").val("sp_HWMS_WasteType_Export"))
