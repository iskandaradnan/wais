...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/CollectionCategory/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['RouteCollectionId', 'Route Code', 'Route Description', 'Route Category', 'Status'],
        colModel: [
            { key: true, hidden: true, name: 'RouteCollectionId', width: '0%' },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("CollectionCategory"))
        .append($("<input name='spName' type='text'>").val("sp_HWMS_CollectionCategory_Export"))
