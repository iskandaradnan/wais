...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/CSWRecordSheet/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['CSWRecordSheetId', 'Document No', 'RRW No.', 'Waste Type', 'Waste Code', ' User Area Code', 'User Area Name', 'Month', 'Year','Collection Type'],
        colModel: [
            { key: true, hidden: true, name: 'CSWRecordSheetId', width: '0%' },
            { key: false, name: 'DocumentNo', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'RRWNo', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'WasteType', width: '15%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'WasteCode', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'UserAreaCode', width: '15%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("CSWRecordSheet"))
        .append($("<input name='spName' type='text'>").val("sp_HWMS_CSWRecordSheet_Export"))
