...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/TransportationCategory/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['RouteTransportationId', 'Route Code', 'Route Description', 'Route Category', 'Status'],
        colModel: [
            { key: true, hidden: true, name: 'RouteTransportationId', width: '0%' },
            { key: false, name: 'RouteCode', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'RouteDescription', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'RouteCategory', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
        ...
        width: '100%',
        viewrecords: true,
        sortname: 'RouteTransportationId',
        sortorder: 'desc',
        excel: true,
        subGrid: false,
        subGridOptions: {
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("TransportationCategory"))
        .append($("<input name='spName' type='text'>").val("sp_HWMS_TransportationCategory_Export"))
