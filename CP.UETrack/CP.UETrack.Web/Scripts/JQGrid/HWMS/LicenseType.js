...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/HWMSLicenseType/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['LicenseTypeId','License Type',' Waste Category',  'Waste Type'],
        colModel: [
            { key: true, hidden: true, name: 'LicenseTypeId', width: '0%' },           
            { key: false, name: 'LicenseOfType', width: '30%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'WasteCategory', width: '35%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'WasteType', width: '35%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
        ],
        pager: jQuery('#pager'),
        rowNum: 5,
        rowList: [5, 10, 20, 50],
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='spName' type='text'>").val("sp_HWMS_LicenseType_Export"))
