...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/ConsignmentNoteCWCN/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['ConsignmentId', 'Consignment Note No', 'Date/Time', 'QC', 'Treatment Plant', 'Driver Code', 'Driver Name', 'Total No.of Bins','Total Est(Kg)'],
        colModel: [
            { key: true, hidden: true, name: 'ConsignmentId', width: '15%' },
            ...
            { key: false, name: 'QC', width: '12%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'TreatmentPlantName', width: '12%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'DriverCode', width: '12%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'DriverName', width: '12%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'TotalNoOfBins', width: '12%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'TotalEst', width: '12%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("ConsignmentNoteCWCN"))
        .append($("<input name='spName' type='text'>").val("sp_HWMS_ConsignmentNoteCWCN_Export"))
