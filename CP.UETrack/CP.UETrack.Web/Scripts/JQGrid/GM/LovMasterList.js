$(function () {
    var ServiceValues = "System:System;User:User;";
...
function genarateGrid(serviceValues) {
    ...
    grid.jqGrid({
        url: "/api/LovMaster/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['LovId', 'Module Name', 'Screen Name', 'LOV Key', 'LOV Type'],
        colModel: [
            { key: true, hidden: true, name: 'LovId', width: '0%' },
            { key: false, search: true, name: 'ModuleName', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc'] } },
            { key: false, name: 'ScreenName', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc'] } },
            { key: false, name: 'LovKey', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc'] } },
            { key: false, name: 'LovType', width: '25%', stype: "select", searchoptions: { sopt: ["eq", "ne"], value: ServiceValues, defaultValue: "System" } },
            //{ name: 'edit', search: false, index: 'LovKey', width: '5%', sortable: false, formatter: editLink },
            //{ name: 'view', search: false, index: 'LovKey', width: '5%', sortable: false, formatter: viewLink },
        ],
        pager: jQuery('#pager'),
        rowNum: 5,
        rowList: [5, 10, 20, 50],
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("List_Of-Values"))
          .append($("<input name='spName' type='text'>").val("uspFM_FMLovMst_Export"))
