$(function () {
    ...
    var UserTypeValues = "Company Admin User:Company Admin User;Company User:Company User;External User:External User;Facility User:Facility User;Super Admin:Super Admin";
...
function genarateGrid(statusValues, userTypeValues) {
    ...
    grid.jqGrid({
        url: "/api/userRegistration/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['Id', 'Customer Name', 'Staff Name', 'Username', 'Login User Type', 'Designation', 'Email', 'Central Pool', 'Status'],
        colModel: [
            ...
            { key: false, search: true, name: 'StaffName', width: '12%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'UserName', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'UserTypeValue', width: '13%', stype: "select", searchoptions: { sopt: ["eq", "ne"], value: UserTypeValues, defaultValue: "Company Admin User" } },
            //{ key: false, search: true, name: 'AccessLevelValue', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'Designation', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'Email', width: '14%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'CenterPool', width: '8%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'StatusValue', width: '8%', stype: "select", searchoptions: { sopt: ["eq", "ne"], value: StatusValues, defaultValue: "Active" } },
            //{ name: 'edit', search: false, index: 'UserRegistrationId', width: '5%', sortable: false, formatter: editLink },
            //{ name: 'delete', search: false, index: 'UserRegistrationId', width: '5%', sortable: false, formatter: deleteLink },
        ...
        //        window.location.href = "/um/userregistration/add";
        //    }
        //}
...
//    if (rowObject.IsBlocked == "1") {
//        return "<span class='glyphicon glyphicon-ban-circle' style='cursor:default;color:#477ca9;font-size: 13px;'></span>";
//    }
//    else {
//        return "<a href='/um/userregistration/edit/" + rowObject.UserRegistrationId + "' class='glyphicon glyphicon-edit' style='color:#477ca9;font-size: 13px;'></a>";
//    }
//}
...
//    if (rowdata.IsBlocked == "1") {
//        return "<span class='glyphicon glyphicon-ban-circle' style='cursor:default;color:#477ca9;font-size: 13px;'></span>";
//    }
//    else {
//        return "<a href='javascript:confirmDelete(" + rowdata.UserRegistrationId + ',' + '"' + Name + '"' + ',' + '"'
//         + staffName + '"' + ',' + '"' + gridID + '"'
//         + ")' class='glyphicon glyphicon-remove' style='color:red;font-size: 13px;'></a>";
//    }
//}
//function viewLink(cellValue, options, rowObject, action) {
//    return "<a href='/um/userregistration/view/" + rowObject.UserRegistrationId + "' class='glyphicon glyphicon-eye-open' style='color:#477ca9;font-size: 13px;'></a>";
//}
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("User_Registration"))
          .append($("<input name='spName' type='text'>").val("uspFM_UMUserRegistration_Export"))
