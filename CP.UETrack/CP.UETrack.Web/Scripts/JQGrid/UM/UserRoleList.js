$(function () {
    ...
    var UserTypeValues = "Company Admin User:Company Admin User;Company User:Company User;External User:External User;Facility User:Facility User;";
        genarateGrid(ServiceValues, UserTypeValues);
});
...
function genarateGrid(serviceValues, userTypeValues) {
    ...
    grid.jqGrid({
        url: "/api/userRole/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['Id', 'Role Name', 'User Type', 'Status'],
        colModel: [
            { key: true, hidden: true, name: 'UMUserRoleId', width: '0%' },
            { key: false, search: true, name: 'UserRole', width: '30%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'UserTypeValue', width: '35%', stype: "select", searchoptions: { sopt: ["eq", "ne"], value: UserTypeValues, defaultValue: "Company Admin User" } },
            { key: false, name: 'StatusValue', width: '35%', stype: "select", searchoptions: { sopt: ["eq", "ne"], value: ServiceValues, defaultValue: "Active" } },
            //{ name: 'edit', search: false, index: 'UMUserRoleId', width: '5%', sortable: false, formatter: editLink },
            //{ name: 'delete', search: false, index: 'UMUserRoleId', width: '5%', sortable: false, formatter: deleteLink },
            //{ name: 'view', search: false, index: 'UMUserRoleId', width: '5%', sortable: false, formatter: viewLink },
        ...
        //        window.location.href = "/um/userrole/add";
        //    }
        //}
        //)
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
         ...
         .append($("<input name='screenName' type='text'>").val("User_Role"))
         .append($("<input name='spName' type='text'>").val("uspFM_UMUserRole_Export"))
