...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/PeriodicWorkRecord/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['PeriodicId', 'CustomerId', 'FacilityId', 'DocumentNo', 'Year', 'Month'],
        colModel: [
            { key: true, hidden: true, name: 'PeriodicId', width: '0%' },
            { key: false, hidden: true, name: 'CustomerId', width: '0%' },
            { key: false, hidden: true, name: 'FacilityId', width: '0%' },
            { key: false, search: true, name: 'DocumentNo', width: '50%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'Year', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'Month', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("PeriodicWorkRecord"))
        .append($("<input name='spName' type='text'>").val("SP_CLS_PeriodicWorkRecord_Export"))
