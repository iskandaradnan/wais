...
function genarateGrid() {
    ...
    var grid = $("#grid"),
        ...
        colNames: ['No', 'User Area Code', 'User Area', 'Done', 'Not Done'],
        colModel: [
            { key: true, search: true, hidden: true, name: 'No', width: '0%' },
            { key: false, search: true, name: 'ChemicalName', width: '15%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: false, name: 'Category', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: false, name: 'AreaofApplication', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
