...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/DeptAreaDetails/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['UserAreaId', 'DeptAreaId', 'CustomerId', 'FacilityId', 'User Area Code', 'User Area Name', 'Category Of Area',
             'Total Receptacles', 'Cleanable Area', 'No. of HandWashing Facilities', 'No Of Beds',
            'Total No Of User Locations', 'Status'],

        colModel: [
            { key: false, hidden: true, name: 'UserAreaId', width: '0%' },
            { key: true, hidden: true, name: 'DeptAreaId', width: '0%' },
            { key: false, hidden: true, name: 'CustomerId', width: '0%' },
            { key: false, hidden: true, name: 'FacilityId', width: '0%' },    
            ...
            { key: false, search: true, name: 'CategoryOfArea', width: '15%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false,  name: 'TotalReceptacles', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'CleanableArea', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false,  name: 'NoOfHandWashingFacilities', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'NoOfBeds', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'TotalNoOfUserLocations', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'Status', width: '5%', searchoptions: { sopt: ['eq'] } },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("DeptAreaDetails"))
        .append($("<input name='spName' type='text'>").val("Sp_CLS_DeptAreaDetails_Export"))
