...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/DailyCleaningActivity/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['DailyActivityId', 'Document No', 'Date', 'Total Done', 'Total Not Done'],
        colModel: [
            { key: true, hidden: true, name: 'DailyActivityId', width: '0%' },
            { key: false, name: 'DocumentNo', width: '30%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'strDate', width: '30%', searchoptions: { sopt: ['cn', 'eq'] } },
            { key: false, name: 'TotalDone', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, name: 'TotalNotDone', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
        ],
        pager: jQuery('#pager'),
        rowNum: 5,
        rowList: [5, 10, 20, 50],
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("DailyCleaningActivity"))
        .append($("<input name='spName' type='text'>").val("SP_CLS_DailyCleaningActivity_EXPORT"))
