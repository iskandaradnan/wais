...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/JIDetails/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['DetailsId', 'JI Document No.','JI Date & Time', 'User Area Code', 'User Area Name',
            'Satisfactory','Unsatisfactory','Not Applicable','No. of User Location','Grand Total Elements Inspected'],
        colModel: [
            { key: true, hidden: true, name: 'DetailsId', width: '10%' },
            { key: false, name: 'DocumentNo', width: '15%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: false,  name: 'DateTime', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false,name: 'UserAreaCode', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false,name: 'UserAreaName', width: '15%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
           
            { key: false, hidden: false, name: 'Satisfactory', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, hidden: false, name: 'UnSatisfactory', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, hidden: false, name: 'NotApplicable', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, hidden: false, name: 'NoofUserLocation', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, hidden: false, name: 'GrandTotalElementsInspected', width: '10%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("JiDetails"))
        .append($("<input name='spName' type='text'>").val("sp_CLS_JiDetails_Export"))
