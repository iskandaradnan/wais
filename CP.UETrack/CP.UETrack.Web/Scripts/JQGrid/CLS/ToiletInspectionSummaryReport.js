...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/ToiletInspectionSummaryReport/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['Total Done', 'Total Not Done'],
        colModel: [
            ...
            { key: false, name: 'TotalDone', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
