...
function genarateGrid(statusValues, ContractTypeValues, controllerName) {
    ...
    grid.jqGrid({
        url: "/api/JointInspections/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['Id', 'User Area Code', 'User Area Name ', 'Hospital Representative ', 'Company Representative', 'Days',],
        colModel: [
            ...
            { key: false, search: true, name: 'Days', width: '20%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
