...
function genarateGrid() {
    ...
    grid.jqGrid({
        ...
        colNames: ['ChemicalId', 'Document No', 'Date'],
        colModel: [
            { key: true, hidden: true, name: 'ChemicalId', width: '0%' },
            { key: false, search: true, name: 'DocumentNo', width: '50%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: false, name: 'Date', width: '50%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },           
            ],
        pager: jQuery('#pager'),
        rowNum: 5,
        rowList: [5, 10, 20, 50],
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("Chemical_In_Use"))
        ...
        .append($("<input name='spName' type='text'>").val("sp_CLS_ChemicalInUse_Export"))
