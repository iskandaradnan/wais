...
function genarateGrid() {
    ...
    grid.jqGrid({
        ...
        colModel: [
            ...
            { key: false, search: true, name: 'IndicatorNo', width: '50%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false, search: true, name: 'IndicatorName', width: '50%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='spName' type='text'>").val("Sp_CLS_IndicatorMaster_Export"))
