...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/ToiletInspection/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['ToiletInspectionId', 'CustomerId', 'FacilityId', 'DocumentNo', 'Date', 'TotalDone', 'TotalNotDone'],
        colModel: [
            { key: true, hidden: true, name: 'ToiletInspectionId', width: '10%' },
            { key: false, hidden: true, name: 'CustomerId', width: '0%' },
            { key: false, hidden: true, name: 'FacilityId', width: '0%' },
            { key: false, search: true, name: 'DocumentNo', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
            { key: false,  name: 'strDate', width: '25%', searchoptions: { sopt: ['cn', 'eq'] } },
            { key: false, name: 'TotalDone', width: '25%', searchoptions: { sopt: ['cn', 'eq'] } },
            { key: false, name: 'TotalNotDone', width: '25%', searchoptions: { sopt: ['cn', 'eq', 'ne', 'bw', 'bn', 'ew', 'en', 'nc', 'nu', 'nn'] } },
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("ToiletInspection"))
        .append($("<input name='spName' type='text'>").val("SP_CLS_ToiletInspectionTxn_Export"))
