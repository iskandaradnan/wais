...
function genarateGrid() {
    ...
    grid.jqGrid({
        url: "/api/JIScheduleGeneration/GetAll",
        datatype: 'json',
        mtype: 'Get',
        ajaxGridOptions: { contentType: 'application/json; charset=utf-8' },
        colNames: ['JIId', 'Year', 'Month', 'Month', 'Week'],
        colModel: [
            { key: true, hidden: true, name: 'JIId', width: '1%' },
            { key: false, name: 'Year', width: '33%', searchoptions: { sopt: [ 'eq', 'ne'] } },
            { key: false, hidden: true, search: true, name: 'Month', searchoptions: { sopt: ['cn', 'eq',  'bw'] } }, 
            { key: false, name: 'MonthName', width: '33%', searchoptions: { sopt: ['cn', 'eq', 'bw'] } }, 
            { key: false, name: 'Week', width: '33%', searchoptions: { sopt: ['cn', 'eq', 'ne'] } }         
        ],
        pager: jQuery('#pager'),
        rowNum: 5,
        rowList: [5, 10, 20, 50],
...
function Export(exportType) {
    ...
    var $downloadForm = $("<form method='POST'>")
        ...
        .append($("<input name='screenName' type='text'>").val("JIScheduleGeneration"))
        .append($("<input name='spName' type='text'>").val("Sp_CLS_JIScheduleGeneration_Export"))
