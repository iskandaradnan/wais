var ASISWeb = function () {
    ...
    return {
        ...
        FormatDateTime: function (jsonDate) {
            ...
            var month = ASISWeb.Pad(d.getMonth() + 1);
            var day = ASISWeb.Pad(d.getDate());
            var hour = ASISWeb.Pad(d.getHours());
            var minutes = ASISWeb.Pad(d.getMinutes());
...
//appUETrack.directive('userName', function () {
//    return {
//        require: 'ngModel',
//        restrict: 'A',
