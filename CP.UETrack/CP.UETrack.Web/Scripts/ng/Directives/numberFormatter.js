...
(function () {
    ...
    appUETrack.directive('asisNumber', [
      'fcsaNumberConfig', function (fcsaNumberConfig) {
          ...
          getOptions = function (scope) {
              ...
              if (scope.options != null) {
                  ...
                  for (option in _ref) {
                      if (!Object.prototype.hasOwnProperty.call(_ref, option)) continue;
                      value = _ref[option];
              ...
              link: function (scope, elem, attrs, ngModelCtrl) {
                  ...
                  ngModelCtrl.$parsers.unshift(function (viewVal) {
                      ...
                      if (isValid(noCommasVal) || !noCommasVal) {
                          ngModelCtrl.$setValidity('asisNumber', true);
                          return noCommasVal;
                      } else {
                          ngModelCtrl.$setValidity('asisNumber', false);
                          return void 0;
                      }
                  });
    ...
    appUETrack.provider('fcsaNumberConfig', function () {
        var _defaultOptions;
        _defaultOptions = {};
