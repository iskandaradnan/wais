...
$(document).ready(function () {
    $("#btnSave, #btnSaveandAddNew").click(function () {
        ...
        $.post("/Api/Indicator/Save", Obj, function (response) {
...
function LinkClicked(id) {
    ...
    if (primaryId != null && primaryId != "0") {
        $.get("/api/Indicator/Get/" + primaryId)
            .done(function (result) {
                var getResult = JSON.parse(result);

                $('#primaryID').val(getResult.IndicatorMasterId);
                ...
                if (IndicatorSd != "") {
                    $('#txtIndicatorStandard').prop("disabled", false);   //txtIndicatorName
