...
var isKPIValue1 = false;
var KPIExportType = '';

function DisplayEditablePopup(divSearch, popupObject, apiUrl, indicatorNo, isDemeritPoint, isKPIValue) {
    divSearch1 = divSearch;
    popupObject1 = popupObject;
    apiUrl1 = apiUrl;
    indicatorNo1 = indicatorNo;
    isDemeritPoint1 = isDemeritPoint;
    isKPIValue1 = isKPIValue;
    if (isDemeritPoint) KPIExportType = 'Demerit';
    if (isKPIValue) KPIExportType = 'KPIValue';
                    ...
                    + '<div class="container-fluid" style="padding-left: 0px;">'
                        + '<div class="content-area">'
                            + '<div class="new-row new-row-tablet new-row-mobile twelve-columns twelve-columns-tablet">'
                                ...
                                + '<div class="col-sm-4 text-center"><button type="button" id="btnKPIExport" class="btn btn-primary customButton"><i class="fa fa-file-excel-o" aria-hidden="true"></i>Export</button></div>'
                ...
                if (specialCaseField == "Primary Key" || specialCaseField == "Timestamp") {
                    ...
                    if (isDemeritPoint) {
                        switch (columnName) {
                            ...
                            case "ServiceWorkDateTime": tdWidth = 7.5; break;
                            ...
                            case "DowntimeHrs": thWidth = 6; break;
                            case "DemeritPoint": thWidth = 6.5; break;

                            case "TCDate": thWidth = 19; break;
                            case "TCDocumentNo": thWidth = 19; break;
                            case "RequiredDateTime": thWidth = 19; break;
                            case "TCCompletedDate": thWidth = 19; break;
                            case "TCStatus": thWidth = 19; break;
                        }
                    }
                    else if (isKPIValue) {
                        switch (columnName) {
                            case "SerialNo": thWidth = 10; break;
                            case "AssetNo": thWidth = 24; break;
                            case "PurchaseCostRM": thWidth = 16.5; break;
                            case "DemeritValue1": thWidth = 16.5; break;
                            case "DemeritPoint": thWidth = 16.5; break;
                            case "DeductionValue": thWidth = 16.5; break;
                        }
                    }
                       tableString += '<th style="width:' +thWidth + '%">' +value.split('-')[1]+ '</th>'
                }
            });
            //tableString += '<th style="widht:20%">Proposed Date</th>';
...
function SaveWorkOrderDetals() {
        ...
        var sortOrder = "asc";
        var screenName = "Deduction_Generation_" + indicatorNo1;
                ...
                if (specialCaseField == "Primary Key" || specialCaseField == "Timestamp") {
                    ...
                    if (isDemeritPoint1) {
                        switch (columnName) {
                            ...
                            case "DowntimeHrs": tdWidth = 6; break;//10
                            case "DemeritPoint": tdWidth = 6.5; break;//10
                        ...
                        switch (columnName) {
                            case "SerialNo": tdWidth = 10; break;
                            case "AssetNo" : tdWidth = 24; break;
                            case "PurchaseCostRM": tdWidth = 16.5; break;
                            case "DemeritValue1": tdWidth = 16.5; break;
                            case "DemeritPoint": tdWidth = 16.5; break;
                            case "DeductionValue": tdWidth = 16.5; break;
                    }
                    }
                    ...
                    if (columnName == 'DowntimeHrs' || columnName == 'PurchaseCostRM' || columnName == 'DemeritValue1' || columnName == 'DemeritPoint' || columnName == 'DeductionValue')
                    {
                        textAlign = 'text-align:right;';
                    }
                    if (columnName == 'ResponseDateTime' || columnName == 'StartDateTime' || columnName == 'EndDateTime' || columnName == 'ServiceWorkDateTime') {
                    ...
                    } else if (columnName == 'TCDate' || columnName == 'TCCompletedDate' || columnName == 'RequiredDateTime') {
                        ...
                        if (columnName == 'PurchaseCostRM' || columnName == 'DemeritValue1') {
