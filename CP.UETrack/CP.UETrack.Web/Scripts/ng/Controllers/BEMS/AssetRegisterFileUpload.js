...
$(document).ready(function () {  
    ...
    formInputValidation("AssetRegisterAttachmentForm");

    $("#AssetAttachmentTab").click(function () {
    ...
    $('#btnEditAttachment,#btnSaveAttachment').click(function () {
        ...
        var isFormValid = formInputValidation("AssetRegisterAttachmentForm", 'save');
        if (!isFormValid) {
...
function BindGetByIdVal(getResult) {
    ...
    $.each(getResult.FileUploadList, function (ind, data) {
        ...
        if (ActionType == "View") {
            $("#AssetRegisterAttachmentForm :input:not(:button)").prop("disabled", true);
