...
function validation() {
    $('.validate').on('paste input', function (e) {
        var $this = $(this);
        setTimeout(function () {
    ...
    $('.validate').on('input', function (e) {
        if ((e.charCode < 97 || e.charCode > 122) && (e.charCode < 47 || e.charCode > 58) && (e.charCode < 40 || e.charCode > 41) && (e.charCode < 65 || e.charCode > 90) && (e.charCode != 45) && (e.charCode != 32) && (e.charCode != 0))
            return false;
    });
}