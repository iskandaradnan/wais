$('#liAFAdditionalInfo').click(function () {
    ...
    $.get("/api/additionalFields/LoadAdditionalInfo/" + 315)
     .done(function (result) {
         ...
         if (primaryId != null && primaryId != "0") {
             $.get("/api/additionalFields/GetAdditionalInfoForTAndC/" + primaryId)
...
$('#btnAdditionalInfoEdit').click(function () { 
    ...
    var saveObj = {
        TestingandCommissioningId: $('#primaryID').val(),
        Field1: $('#Field1').val(),
        Field2: $('#Field2').val(),
        Field3: $('#Field3').val(),
        Field4: $('#Field4').val(),
    ...
    var jqxhr = $.post("/api/additionalFields/SaveAdditionalInfoTAndC", saveObj, function (response) {
