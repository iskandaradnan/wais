$('#liAFAdditionalInfo').click(function () {
    ...
    $.get("/api/additionalFields/LoadAdditionalInfo/" + 335)
     .done(function (result) {
         ...
         if (primaryId != null && primaryId != "0") {
             $.get("/api/BerOne/GetAdditionalInfoForAsset/" + primaryId)
...
$('#btnAdditionalInfoEdit').click(function () {
    ...
    var jqxhr = $.post("/api/BerOne/SaveAdditionalInfoForAsset", saveObj, function (response) {
...
$("#btnAdditionalInfoCancel1").click(function () {
