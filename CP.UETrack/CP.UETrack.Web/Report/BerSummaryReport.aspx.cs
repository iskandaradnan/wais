...
{
    public partial class BerSummaryReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    reportViewer.LocalReport.ReportPath = Server.MapPath(Request.ApplicationPath) + @"RdlReports\LatestReportsRDLC\BER_Summary_Rpt.rdlc";
                    var datasource = new ReportDataSource("DataSet1", GetSPResult("uspFM_BERApplicationTxn_BERSummary_Rpt", BerFromdate, BerTodate));
        ...
        protected void reportViewer_Drillthrough(object sender, DrillthroughEventArgs e)
        {
            ...
            var datasource = new ReportDataSource("uspFM_BERApplicationTxn_BERSummary_Rpt_L2", GetSPResult("uspFM_BERApplicationTxn_BERSummary_Rpt_L2", BerFromdate, BerTodate, ParameterName));
            localreport.DataSources.Clear();
            localreport.DataSources.Add(datasource);
            localreport.Refresh();
            var datasource1 = new ReportDataSource("uspFM_BERApplicationTxn_BERSummary_Rpt_L3", GetSPResult("uspFM_BERApplicationTxn_BERSummary_Rpt_L3", BerFromdate, BerTodate, ParameterName));
                ...
                try
                {
                    ...
                    using (SqlConnection con = new SqlConnection(dbAccessDAL.ConnectionString))
                    {
                        using (SqlCommand cmd = new SqlCommand())
                        {
                            ...
                            switch (Spname)
                            {
                                case "uspFM_BERApplicationTxn_BERSummary_Rpt":
                                    cmd.CommandText = "uspFM_BERApplicationTxn_BERSummary_Rpt";
                                ...
                                case "uspFM_BERApplicationTxn_BERSummary_Rpt_L2":
                                    ...
                                    break;
                                case "uspFM_BERApplicationTxn_BERSummary_Rpt_L3":
                                    cmd.CommandText = "uspFM_BERApplicationTxn_BERSummary_Rpt_L3";
                                    cmd.Parameters.Clear();
                                    cmd.Parameters.AddWithValue("@FacilityId", userDetails.FacilityId);
                                    cmd.Parameters.AddWithValue("@From_Date", BerFromdate);
                                    cmd.Parameters.AddWithValue("@To_Date", BerTodate);
