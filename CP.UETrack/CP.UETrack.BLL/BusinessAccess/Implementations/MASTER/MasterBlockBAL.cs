...
{
    public class MasterBlockBAL : IMasterBlockBAL
    {
        private string _FileName = nameof(MasterBlockBAL);
        IMasterBlockDAL _BlockDAL;

        public MasterBlockBAL()
        {
            _BlockDAL = new MasterBlockDAL();
        }
        public MasterBlockBAL(IMasterBlockDAL MasterBlockDAL)
        {
            _BlockDAL = MasterBlockDAL;
        }
