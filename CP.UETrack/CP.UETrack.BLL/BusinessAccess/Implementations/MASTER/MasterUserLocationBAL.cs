...
using System;
using CP.UETrack.BLL.BusinessAccess.Implementations.MASTER;

namespace CP.UETrack.BLL.BusinessAccess.Implementations.Master
{
    public class MasterUserLocationBAL : IMasterUserLocationBAL
    {
        private readonly IMasterUserLocationDAL _userLocationDAL;
        private readonly IMasterUserAreaDAL _userareaDal;
        private readonly static string fileName = nameof(MasterUserAreaBAL);
        public MasterUserLocationBAL(IMasterUserLocationDAL dal, IMasterUserAreaDAL areadal)
        {
    ...
    //internal interface IMasterUserLocationDAL
    //{
    //}
}
