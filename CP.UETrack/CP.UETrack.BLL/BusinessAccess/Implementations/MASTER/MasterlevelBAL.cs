...
{
    public class MasterlevelBAL : IMasterLevelBAL
    {
        private string _FileName = nameof(MasterlevelBAL);
        IMasterLevelDAL _LevelDAL;


        public MasterlevelBAL()
        {
            _LevelDAL =new MasterlevelDAL();
        }

        public MasterlevelBAL(IMasterLevelDAL MasterlevelDAL)
        {
            _LevelDAL = MasterlevelDAL;
        }
