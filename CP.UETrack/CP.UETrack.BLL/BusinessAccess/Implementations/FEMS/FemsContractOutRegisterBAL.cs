...
{
    class FemsContractOutRegisterBAL : IFemsContractOutRegisterBAL
    {

        private readonly IFemsContractOutRegisterDAL _IContractOutRegisterDAL;
       // private readonly IAssetRegisterDAL _IAssetRegisterDAL;
        private readonly static string fileName = nameof(FemsContractOutRegisterBAL);
        public FemsContractOutRegisterBAL(IFemsContractOutRegisterDAL IFemsContractOutRegisterDAL /*, IAssetRegisterDAL IAssetRegisterDAL*/)
        {
            _IContractOutRegisterDAL = IFemsContractOutRegisterDAL;
