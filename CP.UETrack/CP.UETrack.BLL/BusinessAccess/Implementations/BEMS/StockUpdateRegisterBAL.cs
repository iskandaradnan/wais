...
{
   public class StockUpdateRegisterBAL : IStockUpdateRegisterBAL
    {


        private readonly  IStockUpdateRegisterDAL _IStockUpdateRegisterDAL;
        private readonly static string fileName = nameof(StockUpdateRegisterBAL);
        public StockUpdateRegisterBAL(IStockUpdateRegisterDAL IStockUpdateRegisterDAL)
        {
