...
namespace CP.UETrack.BLL.BusinessAccess
{
    ...
    {
        private string _FileName = nameof(CorrectiveActionReportBAL);
        ICorrectiveActionReportDAL _CorrectiveActionReportDAL;

        public CorrectiveActionReportBAL(ICorrectiveActionReportDAL correctiveActionReportDAL)
        {
            _CorrectiveActionReportDAL = correctiveActionReportDAL;
        }
        ...
        public CorrectiveActionReport Save(CorrectiveActionReport correctiveActionReport, out string ErrorMessage)
        {
            try
            {
                ...
                if (IsValid(correctiveActionReport, out ErrorMessage))
                {
                    result = _CorrectiveActionReportDAL.Save(correctiveActionReport, out ErrorMessage);
                }
        ...
        private bool IsGridValid(CorrectiveActionReport correctiveActionReport, out string ErrorMessage)
        {
            ...
            foreach (var item in correctiveActionReport.activities)
            {
                ...
                if (item.StartDate.Date > correctiveActionReport.CARTargetDate)
                {
                    ErrorMessage = "Activity Start Date should be less than or equal to CAR Target Date";
                    break;
                }
                if (item.TargetDate.Date > correctiveActionReport.CARTargetDate)
                {
                    ErrorMessage = "Activity Target Date should be less than or equal to CAR Target Date";
                    break;
                }
        ...
        public CorrectiveActionReport Get(int Id, int PageIndex, int PageSize)
        {
            try
            {
                ...
                var result = _CorrectiveActionReportDAL.Get(Id, PageIndex, PageSize);
        ...
        public CARWorkOrderList GetWorkOrderDetails(int Id)
        {
            try
            {
                ...
                var result = _CorrectiveActionReportDAL.GetWorkOrderDetails(Id);
        ...
        public CARWorkOrderList SaveWorkOrderDetails(CARWorkOrderList carWorkOrderList)
        {
            try
            {
                ...
                var result = _CorrectiveActionReportDAL.SaveWorkOrderDetails(carWorkOrderList);
        ...
        public void Delete(int Id)
        {
            try
            {
                ...
                _CorrectiveActionReportDAL.Delete(Id);
        ...
        public RootCauseList GetRootCauses(int Id)
        {
            try
            {
                ...
                var result = _CorrectiveActionReportDAL.GetRootCauses(Id);
