...
namespace CP.UETrack.Model.BEMS
{
        ...
        public class ARPApplicationTxn
        {
            ...
            public List<ARPApplicationRemarksHistoryTxn> BERApplicationRemarksHistoryTxns { get; set; }
            public List<ARPMaintananceHistoryDet> BERMaintananceHistoryDets { get; set; }
            public List<ARPApplicationHistoryTxn> BERApplicationHistoryTxns { get; set; }
            public List<ArpCurrentValueHistoryTxnDet> BerCurrentValueHistoryTxnDets { get; set; }
        ...
        public class ARPApplicationHistoryTxn
    {
        ...
        public class ArpAdditionalFields
        {
            public int ApplicationId { get; set; }
