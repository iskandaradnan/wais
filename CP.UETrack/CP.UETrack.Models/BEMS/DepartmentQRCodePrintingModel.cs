...
{
    public class DepartmentQRCodePrintingModel
    {
        ...
        public List<ItemDeptQRCodeList> DeptQRCodeListData { get; set; }
        public List<sqlQueryExpressionList> sqlQueryExpressionListData { get; set; }
    }

    public class ItemDeptQRCodeList
    {
        public int BlockId { get; set; }
        ...
        public int QRCodeUserAreaId { get; set; }
